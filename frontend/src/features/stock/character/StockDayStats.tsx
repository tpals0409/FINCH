...
import { StatCell } from '@/shared/ui/character/StatCell';
...
export function StockDayStats({ stockCode }: StockDayStatsProps) {
  ...
  if (isError) {
    ...
    // 같은 카드 안에 재시도 버튼이 둘 보이면 무엇을 다시 받는지 헷갈린다.
    return null;
  }
