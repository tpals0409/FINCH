...
data class ErrorResponse(
	...
	companion object {
		...
		fun of(errorCode: BaseErrorCode, detail: Any? = null): ErrorResponse =
			ErrorResponse(errorCode.code, errorCode.message, detail, null)
		 ...
		 */
		fun ofAiRelay(code: String, message: String, detail: Any?, requestId: String?): ErrorResponse =
			ErrorResponse(code, message, detail, requestId)
	}
}
